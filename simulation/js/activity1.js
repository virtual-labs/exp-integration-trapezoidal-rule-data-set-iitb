...
function activity1() {
    ...
    <div class='divide'>
        <div style='margin-top: 2vw;'>
            <br>
            <h4 class="center-text fs-20px fw-600">Integration: Trapezoidal Rule</h4>
            <p>Objective: To calculate the integration by Trapezoidal rule</p>
...
function load_I() {
   ...
   <div id="I-div">
      <div class="row justify-content-center" style="align-items:center">
         <div class="col-md-7">
            $$ I = \\frac{h}{2} (Y_1+2Y_2+2Y_3+2Y_4+2Y_5+2Y_6+Y_7) =  $$
         </div>
         <div class="col-md-4">
